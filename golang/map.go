...
type hmap struct {
	...
	flags     uint8
	B         uint8  // 说明包含2^B个bucket, log_2 of # of buckets (can hold up to loadFactor * 2^B items)
	noverflow uint16 // 溢出的bucket的个数, approximate number of overflow buckets; see incrnoverflow for details
